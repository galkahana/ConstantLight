...
InputBufferedStream::InputBufferedStream(LongBufferSizeType inBufferSize)
{
	Initiate(NULL,inBufferSize);
}

InputBufferedStream::InputBufferedStream(IByteReaderWithPosition* inSourceReader,LongBufferSizeType inBufferSize)
{
...
void InputBufferedStream::Initiate(IByteReaderWithPosition* inSourceReader,LongBufferSizeType inBufferSize)
{
